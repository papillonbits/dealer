...
describe('index', () => {
  ...
  test('must return all constants', () => {
    ...
    expect(constants).toHaveProperty('fuelPriceRange')
    expect(constants).toHaveProperty('monthlyTravelDistanceRange')
    expect(constants).toHaveProperty('yearPeriodRange')
    expect(constants).toHaveProperty('costDefaults')
  })
})
